...
void fw_set_roam_mac(const char *mac)
{
 ...
 *
 */
void fw_client_process_from_authserver_response(t_authresponse *authresponse, t_client *p1)
{
  s_config *config = config_get_config();
 ...
 *
 */
void ev_fw_sync_with_authserver_v2(struct wd_request_context *context)
{
 ...
 *
 */
void ev_fw_sync_with_authserver(struct wd_request_context *context)
{
  t_client *p1 = NULL, *p2 = NULL, *worklist = NULL;
  s_config *config = config_get_config();
